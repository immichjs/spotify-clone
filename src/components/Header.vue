<template>
    <header class="container">
        ...
        <nav class="nav">
            <ul>
                <li class="items"><a href="#">Premium</a></li>
                <li class="items"><a href="#">Suporte</a></li>
                <li class="items"><a href="#">Baixar</a></li>
                <li class="separator">|</li>
                <li class="items"><a href="#">Inscrever-se</a></li>
                <li class="items"><a href="#">Entrar</a></li>
            </ul>
        </nav>
    </header>
</template>
